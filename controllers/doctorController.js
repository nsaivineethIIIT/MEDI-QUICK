...
exports.signup = async (req, res) => {
    ...
    try {
        ...
        // Validate registration number (alphanumeric, 6-20 characters)
...
exports.login = async (req, res) => {
    ...
    try {
        ...
        console.log('Doctor logged in, session doctorId set to:', req.session.doctorId);
...
exports.getEditProfile = async (req, res) => {
    try {
        ...
        const doctor = await Doctor.findById(req.session.doctorId)
            .select('name email mobile address specialization college yearOfPassing location onlineStatus consultationFee')
            .lean();
